    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(default='images/default/pic.jpg', upload_to=donations.models.acceptor_upload_to, verbose_name='picture')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
            ],
            options={
                'verbose_name': 'acceptor',
                'verbose_name_plural': 'acceptors',
            },
        ),
        migrations.CreateModel(
            name='Blood',
            fields=[
                ...
                ('been_injured', models.BooleanField(blank=True, null=True, verbose_name='been injured with a used needle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('organization', models.CharField(blank=True, choices=[('COVID-19', 'COVID-19'), ('MAKEDONIA', 'MAKEDONIA'), ('SELE ENAT CHARITABLE', 'SELE ENAT CHARITABLE'), ('ETHIOPIAN CENTER FOR DISABILITY AND DEVLOPMENT', 'ETHIOPIAN CENTER FOR DISABILITY AND DEVLOPMENT')], max_length=300, null=True, verbose_name='organization')),
                ('amount', models.PositiveIntegerField(blank=True, null=True, verbose_name='amount')),
                ('fixed_amount', models.IntegerField(blank=True, choices=[(100, 'One Hundred'), (500, 'Five Hundred'), (1000, 'One Thousand')], null=True, verbose_name='fixed amount')),
                ('code', models.CharField(max_length=4, verbose_name='code')),
                ('number', models.CharField(max_length=40, verbose_name='number')),
                ('country', models.CharField(max_length=40, verbose_name='country')),
                ('city', models.CharField(max_length=40, verbose_name='city')),
