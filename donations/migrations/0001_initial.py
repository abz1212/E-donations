# Generated by Django 3.0.8 on 2020-08-08 07:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sponsors', to=settings.AUTH_USER_MODEL, verbose_name='donor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('donor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='organs', to=settings.AUTH_USER_MODEL, verbose_name='donor')),
            ],
            options={
                'verbose_name': 'organ',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('donor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bloods', to=settings.AUTH_USER_MODEL, verbose_name='donor')),
            ],
            options={
                'verbose_name': 'blood',
